<script lang="ts">
  ...
  const uniqueId = generateButtonId('AlignLeft');
</script>

<AlignmentButton {editor} alignment="left" tooltipText="Align left" buttonId={uniqueId} ariaLabel="Align left" class={className} />
