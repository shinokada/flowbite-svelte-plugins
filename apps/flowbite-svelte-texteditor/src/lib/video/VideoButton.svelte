<script lang="ts">
  ...
  import { type VideoButtonProps } from '$lib';
  import { cn } from '$lib';

  let { editor, format, tooltipText, buttonId, ariaLabel, class: className, onAdvancedClick, ...restProps }: VideoButtonProps = $props();
...
## Type
[VideoButtonProps](https://github.com/shinokada/flowbite-svelte-plugins/blob/main/src/lib/types.ts#L111)
## Props
@prop editor
@prop format
@prop tooltipText
