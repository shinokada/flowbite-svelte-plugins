<script lang="ts">
  ...
  let { modalChildren, editor, tooltipText = "Video with settings", ariaLabel = "Add video with settings", id, modalTitle = "Insert advanced video", modalSize="xs", formId, videoUrl = "https://www.youtube.com/watch?v=KaLxCiilHns", videoWidth, videoHeight, class: className }: VideoAdvancedProps = $props();
