<script lang="ts">
  ...
  const defaultShouldShow = ({ editor, view, state, from, to }: ShouldShowProps) => {
...
<div bind:this={menuElement} class="bubble-menu-wrapper" style="position: absolute; z-index: 50; visibility: hidden;" {...restProps}>
