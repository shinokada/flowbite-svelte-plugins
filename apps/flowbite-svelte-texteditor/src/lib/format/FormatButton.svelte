<script lang="ts">
  ...
  import { type FormatButtonProps } from '$lib';
  import { cn } from '$lib';

  let { editor, format, tooltipText, buttonId, ariaLabel, class: className }: FormatButtonProps = $props();
...
## Type
[FormatButtonProps](https://github.com/shinokada/flowbite-svelte-plugins/blob/main/src/lib/types.ts#L31)
## Props
@prop editor
@prop format
@prop tooltipText
