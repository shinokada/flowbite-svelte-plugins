...
<script lang="ts">
  import { FontButton, HeadingButton, type HeadingButtonGroupProps } from '$lib';
...
## Type
[HeadingButtonGroupProps](https://github.com/shinokada/flowbite-svelte-plugins/blob/main/src/lib/types.ts#L161)
## Props
@prop editor
