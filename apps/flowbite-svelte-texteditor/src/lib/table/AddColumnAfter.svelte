...
<TableButton {editor} format="addColumnAfter" tooltipText="Toggle addColumnAfter" buttonId="toggleAddColumnAfterButton" ariaLabel="Add column after" class={className} />
